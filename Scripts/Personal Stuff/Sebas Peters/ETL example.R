...
Codebook_73 <-
  read_excel("~/Library/Mobile Documents/com~apple~CloudDocs/GitHub/RCourseHWStudyGroup/data/ETL/Codebook_example_73.xlsx")

#bekijk het codeboek in R met:
view(Codebook_73)

Codebook_81 <-
  read_excel("~/Library/Mobile Documents/com~apple~CloudDocs/GitHub/RCourseHWStudyGroup/data/ETL/Codebook_example_81.xlsx")
...
Ref_Codebook <- read_excel("~/Library/Mobile Documents/com~apple~CloudDocs/GitHub/RCourseHWStudyGroup/data/ETL/Ref_codebook.xlsx")
...
if (continue) {
  ...
  Survey_73 <-
    as.data.frame(read_excel("~/Library/Mobile Documents/com~apple~CloudDocs/GitHub/RCourseHWStudyGroup/data/ETL/Example survey 73.xlsx"))
  Survey_81 <-
    as.data.frame(read_excel("~/Library/Mobile Documents/com~apple~CloudDocs/GitHub/RCourseHWStudyGroup/data/ETL/Example survey 81.xlsx"))
